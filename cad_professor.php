...
<body>
	<div class="container" id="sendjobs">
		...
		<?php
                    		...
                    		?>
		<form method="POST" action="proc_cad_professor.php">
							...
							<h align="center">
                                			...
                                			<div class="input-box">
                                				...
                                				<input type="nome_prof" name="nome_prof" placeholder="Insira o nome do professor">
                                			</div>
                                			<div class="input-box">
                                                <label>Insira o curso <span class="required">*</span></label>
                                                <input type="id_prof_curso" name="id_prof_curso" placeholder="Insira o codigo do curso">
                                             </div>
                                			<div class="input-box">
                                				<label>Insira a Cadeira <span class="required">*</span></label>
                                				<input type="disciplina" name="disciplina" placeholder="Insira a disciplina"></input>
                                			</div>
                                			<div class="input-box">
                                				<label>Insira o ano <span class="required">*</span></label>
                                				<input type="id_prof_ano" name="id_prof_ano" placeholder="Insira a turma">
                                			</div>
                                			<div class="input-box">
